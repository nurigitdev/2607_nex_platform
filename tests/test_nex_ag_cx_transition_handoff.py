...
from nex_ag.cx_transition_handoff import (
    ...
    build_ag_cx_transition_handoff,
...
def test_handoff_is_deterministic_sealed_and_verifiable() -> None:
    first = build_ag_cx_transition_handoff(
        _accepted_report(), generated_at=GENERATED_AT
    )
    second = build_ag_cx_transition_handoff(
        _accepted_report(), generated_at=GENERATED_AT
    )
...
def test_verifier_rejects_invalid_package_hash_and_identity() -> None:
    package = build_ag_cx_transition_handoff(
        _accepted_report(), generated_at=GENERATED_AT
    )
    ...
    rebuilt = build_ag_cx_transition_handoff(
        _accepted_report(), generated_at=GENERATED_AT
    )
