...
DEFAULT_PORT = 5317
DEFAULT_SLICE_LABEL = "Slice 0317"
...
@dataclass(frozen=True)
class RetrievalQualityWarningSmokeResult:
    status: str
    slice_label: str
    url: str
...
def required_source_anchors() -> tuple[SourceAnchor, ...]:
    return (
        SourceAnchor("src/retrievalQualityWarnings.js", "ae_web_retrieval_quality_warning_surface.v1"),
        SourceAnchor("src/retrievalQualityWarnings.js", "ae_chat_retrieval_quality_warning.v1"),
        SourceAnchor("src/retrievalQualityWarnings.js", "buildRetrievalQualityWarningSurface"),
        SourceAnchor("src/retrievalQualityWarnings.js", "buildRetrievalQualityWarningSummary"),
        SourceAnchor("src/retrievalQualityWarnings.js", "extractRetrievalQualityWarnings"),
        SourceAnchor("src/retrievalQualityWarnings.js", "proceed_with_caveat"),
        SourceAnchor("src/retrievalQualityWarnings.js", "ask_confirmation"),
        SourceAnchor("src/retrievalQualityWarnings.js", "show_no_answer"),
        SourceAnchor("src/retrievalQualityWarnings.js", "show_error"),
        SourceAnchor("src/retrievalQualityWarnings.js", "rawWarningDetailsIncluded: false"),
        SourceAnchor("src/retrievalClient.js", "qualityWarnings"),
        SourceAnchor("src/retrievalClient.js", "normalizeWarningKinds"),
        SourceAnchor("src/main.js", "renderRetrievalQualityWarningSurface"),
        SourceAnchor("src/main.js", "renderMessageRetrievalQualityWarning"),
        SourceAnchor("src/main.js", "quality_warning"),
        SourceAnchor("src/styles.css", ".quality-warning-surface"),
        SourceAnchor("src/styles.css", ".retrieval-quality-warning-chip"),
    )
...
def run_ae_web_retrieval_quality_warning_smoke(
    *,
    ...
    app_dir: Path = APP_DIR,
) -> RetrievalQualityWarningSmokeResult:
    ...
    try:
        ...
        return RetrievalQualityWarningSmokeResult(
            status=status,
...
def format_summary(result: RetrievalQualityWarningSmokeResult) -> str:
    base = (
        "ae_web_retrieval_quality_warning_smoke="
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_ae_web_retrieval_quality_warning_smoke(
        port=args.port,
