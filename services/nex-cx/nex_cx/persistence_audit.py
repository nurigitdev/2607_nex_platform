...
CX_CONTENT_PERSISTENCE_SURFACES: tuple[dict[str, Any], ...] = (
    {
        ...
        "current_adapter_status": "repository_port_ready",
    ...
    },
    {
        ...
        "postgres_adapter_required": True,
        "private_payload_policy": "summary_hash_preview_uri_only",
    ...
    *,
    ...
    return {
        ...
        "summary": {
            ...
            "next_recommended_slice": "0162_sqlalchemy_content_ingestion_store",
        },
